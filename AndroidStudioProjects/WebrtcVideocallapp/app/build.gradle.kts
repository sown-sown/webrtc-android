...
android {
    namespace = "com.example.webrtcvideocallapp"
    compileSdk = 34
    defaultConfig {
        applicationId = "com.example.webrtcvideocallapp"
        minSdk = 27
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation ("com.google.firebase:firebase-database-ktx:21.0.0")// Updated version
